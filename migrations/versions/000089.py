...
Revision ID: 000089
Revises: 000088
Create Date: 2026-06-03 17:27:11.950
...
revision: str = '000089'
down_revision: Union[str, Sequence[str], None] = '000088'
...
def upgrade() -> None:
    ...
    # From query_001.sql:
    with open("sql/000089/query_001.sql", "r") as f:
...
def downgrade() -> None:
    ...
    # From downgrade.sql:
    with open("sql/000089/downgrade.sql", "r") as f:
